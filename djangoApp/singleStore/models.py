...
class OrderItem(models.Model):
    ...
    def __str__(self):
        return f"{self.quantity} of {self.item.title} invoiced {self.invoiced_quantity} shipped {self.shipped_quantity} refund requested {self.refund_request_quantity}  refund initiated {self.refund_quantity}"
