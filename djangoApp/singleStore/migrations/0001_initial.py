    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField()),
                ('priority', models.IntegerField(blank=True, null=True)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='singleStore.Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='billing_address', to='singleStore.Address')),
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='singleStore.Coupon')),
            ],
        ),
        migrations.CreateModel(
            name='StoreFront',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='singleStore.Item')),
            ],
        ),
        migrations.CreateModel(
            name='Shipment',
            fields=[
                ...
                ('items', models.ManyToManyField(to='singleStore.ShipmentItem')),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='singleStore.Order')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ManyToManyField(to='singleStore.RefundItem')),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='singleStore.Order')),
            ],
            options={
                'verbose_name': 'refund',
        ...
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ManyToManyField(to='singleStore.OrderItem'),
        ),
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='singleStore.Payment'),
        ),
        migrations.AddField(
            model_name='order',
            name='shipping_address',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shipping_address', to='singleStore.Address'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
        ...
        migrations.AddField(
            model_name='item',
            name='Tax_Rate',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='singleStore.TaxRate'),
        ),
        migrations.AddField(
            model_name='item',
            name='brand',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='singleStore.Brand'),
        ),
        migrations.AddField(
            model_name='item',
            name='category',
            field=models.ManyToManyField(to='singleStore.Category'),
        ),
        migrations.CreateModel(
            name='InvoiceItem',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoiced', models.BooleanField(default=False)),
                ('items', models.ManyToManyField(to='singleStore.InvoiceItem')),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='singleStore.Order')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('addresses', models.ManyToManyField(to='singleStore.Address')),
                ('group', models.ManyToManyField(to='singleStore.Group')),
                ('orders', models.ManyToManyField(to='singleStore.Order')),
                ('payments', models.ManyToManyField(to='singleStore.Payment')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_customer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
